...
CREATE TABLE subscriptionData (
  ...
  allApnConfIncludedInd enum(/*'All_APN_CONFIGURATIONS_INCLUDED'*/'0',  /*'MODIFIED_ADDED_APN_CONFIGURATIONS_INCLUDED'*/'1'),
  ratFreqSelPrior int(10) unsigned,
  compDataIndic enum(/*'All_PDP_CONTEXTS_INCLUDED'*/'0', /*'MODIFIED_ADDED_PDP_CONTEXTS_INCLUDED'*/'1'),
  ...
  ratType enum(/*WLAN*/'0',/*VIRTUAL*/ '1',/*UTRAN*/'1000',	/*GERAN*/ '1001',/*GAN*/'1002',	/*HSPA_EVOLUTION*/'1003',/*EUTRAN*/'1004', /*CDMA2000_1X */'2000',/*HRPD*/ '2001',/*UMB*/ '2002',/*EHRPD*/'2003')
...
INSERT INTO subscriptionData VALUES ('244444123456789', /*'SERVICE_GRANTED'*/'0', x'00358441234567', x'00358441234568', x'00358449999999',/*'TRUE'*/'1', '0', '0',x'0001',x'0002',x'0003', '0','apn.oi.repl',x'01',x'02', x'03','cccccc','10','5','1', '0', '1','0','0','1','1','0','0', NULL,'0','1','0','1000');
INSERT INTO resetId VALUES ('244444');
INSERT INTO gprsData VALUES('244444123456789','1','1','abcd','001','0', 'service.select', 'cccccc','01','abcd','10','5','apn.oi.repl','0','0','1','1');
